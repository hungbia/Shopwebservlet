	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9 col-sm-12">
				<form action="/HelloWeb6/admin/product/add" method="post"
					...
					<div class="form-group">
						<label>Giá:</label> <input class="form-control" type="text"
							name="price" placeholder="Nhap gia">
					</div>
					<div class="form-group">
						<label>description:</label> <input class="form-control"
							type="text" name="description" placeholder="Nhap description">
					</div>
					<div class="form-group">
						<label>Image File:</label> <input class="form-control" type="file"
